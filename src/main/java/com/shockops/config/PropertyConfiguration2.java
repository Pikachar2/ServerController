...
@Configuration
public class PropertyConfiguration2 implements InitializingBean {
    ...
    public void initEnvVars() {
        PropertyConfiguration.initEnvVars(arkServersApiQueryUrl, thisServerPort, scriptDir, workDir, arkSavedMapsDir);
    }
